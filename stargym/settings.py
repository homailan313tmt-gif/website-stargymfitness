...
"""
Django settings for stargym project.
...
SECRET_KEY = 'django-insecure-rkxgk8=s$s*4mb%=ucd5y-ve=_=fsbaaw(z$5j8#bg_^#go@8#'
...
WSGI_APPLICATION = 'stargym.wsgi.application'
